        ...
        for iφ in 1:size(ef, 2)
            for ir in 1:size(ef, 1)
                ...
                elseif ir == size(ef,1)
                    ...
                    er = ( Δp_r_1/d_r_1*d_r_2 + Δp_r_2/d_r_2*d_r_1) / (d_r_1 + d_r_2)
                end
                ### φ ###
                if iφ < 2
                    ...
                    eφ = ( Δp_φ_1/d_φ_1*d_φ_2 + Δp_φ_2/d_φ_2*d_φ_1) / (d_φ_1 + d_φ_2)
                elseif iφ == size(ef,2)
                ...
                elseif  iz+1 > size(ef,3)
                    ...
                    ez = ( Δp_z_1/d_z_1*d_z_2 + Δp_z_2/d_z_2*d_z_1) / (d_z_1 + d_z_2)
                end
